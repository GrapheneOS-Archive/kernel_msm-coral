...
PATH="$ROOT_DIR/prebuilts/clang/host/linux-x86/clang-r377782b/bin:$PATH"
...
export LD_LIBRARY_PATH="$ROOT_DIR/prebuilts/clang/host/linux-x86/clang-r377782b/bin:$LD_LIBRARY_PATH"
